...
const MOCK_CATALOGOS = [{
  ...
  ID: 'B1',
  NOMBRE: 'Casa 5',
  EMAIL: 'casa5@email.com',
  EMAIL_CCP: 'ccp5@email.com'
}, {
  ID: 'B2',
  NOMBRE: 'Casa 6',
  EMAIL: 'casa6@email.com',
  EMAIL_CCP: 'ccp6@email.com'
}, {
  ID: 'B3',
  NOMBRE: 'Casa 7',
  EMAIL: 'casa7@email.com',
  EMAIL_CCP: 'ccp7@email.com'
}, {
  ID: 'B4',
  NOMBRE: 'Casa 8',
  EMAIL: 'casa8@email.com',
  EMAIL_CCP: 'ccp8@email.com'
}];
...
/***/ 6867:
/*!****************************************!*\
  !*** ./src/app/mocks/mock-prefijos.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MOCK_PREFIJOS: () => (/* binding */ MOCK_PREFIJOS)
/* harmony export */ });
const MOCK_PREFIJOS = [{
  PREFIX: 'A',
  NOMBRE: 'Antonio',
...
class BaseService {
  ...
  getEntitiesByRange(table, range) {
    const url = this.BASE_URL + `?spreadsheetId=${this.SPREAD_SHEET_ID}&sheet=${table}&sheetRange=${range}`;
    // console.log(url);
    return this._http.get(url, {
      responseType: "json"
    });
   ...
   * @returns json of sheet
   */
  getEntitiesByNameRange(sheet, tanmeName) {
    const url = this.BASE_URL + `?spreadsheetId=${this.SPREAD_SHEET_ID}&sheet=${sheet}&tableName=${tanmeName}`;
    return this._http.get(url, {
      responseType: "json"
    });
  }
...
class GastosService {
  ...
  getCategoriaDef() {
    if (this.categorias$.getValue().length > 0) {
      ...
      return this.categorias$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.delay)(100));
    }
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
  ...
  getFullDataDetail() {
    if (this.gastosDetalle$.getValue().length > 0) {
      ...
      return this.gastosDetalle$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.delay)(100));
    }
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
...
/* harmony import */ var _base_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base.service */ 964);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ 5797);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 9452);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs/operators */ 5074);
...
/* harmony import */ var _mocks_mock_prefijos__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../mocks/mock-prefijos */ 6867);
...
class RecibosService {
  constructor() {
    this.base = (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.inject)(_base_service__WEBPACK_IMPORTED_MODULE_1__.BaseService);
    // constructor(private base: BaseService) {}
    this.recibosDetalle$ = new rxjs__WEBPACK_IMPORTED_MODULE_9__.BehaviorSubject([]);
    this.casas$ = new rxjs__WEBPACK_IMPORTED_MODULE_9__.BehaviorSubject([]);
    this.conceptos$ = new rxjs__WEBPACK_IMPORTED_MODULE_9__.BehaviorSubject([]);
    this.prefijos$ = new rxjs__WEBPACK_IMPORTED_MODULE_9__.BehaviorSubject([]);
  }
  getSpreadSheetId() {
    var _this = this;
    return (0,_home_runner_work_recibos_pagos_recibos_pagos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  getFullData() {
    ...
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.of)(mock).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(500));
    }
    return this.base.getEntitiesByRange('Catalogos', 'E1:I50').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.map)(data => {
  ...
  getFullDataDetail() {
    if (this.recibosDetalle$.getValue().length > 0) {
      // Si ya hay datos en casas$, retorna el observable actual
      return this.recibosDetalle$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(100));
    }
    // Si no hay datos, invoca el método y setea casas$
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
      const mock = _mocks_mock_recibos_detalle__WEBPACK_IMPORTED_MODULE_5__.MOCK_RECIBOS_DETALLE;
      this.recibosDetalle$.next(mock);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.of)(_mocks_mock_recibos_detalle__WEBPACK_IMPORTED_MODULE_5__.MOCK_RECIBOS_DETALLE).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(1500));
    }
    return this.base.getEntities('RecibosDetalle').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.map)(data => {
      this.recibosDetalle$.next(data || []);
      return data || [];
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(this.base.handleError));
  }
  /*   getRecibos() {
  ...
  getConceptos() {
    if (this.conceptos$ && this.conceptos$.getValue().length > 0) {
      ...
      return this.conceptos$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(100));
    }
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
    ...
    return this.base.getEntitiesByRange('Catalogos', 'A1:A50').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.map)(data => {
      data = data.filter(item => item.NOMBRE);
  ...
  getPrefijos() {
    if (this.prefijos$ && this.prefijos$.getValue().length > 0) {
      return this.prefijos$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(100));
    }
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
      const mock = _mocks_mock_prefijos__WEBPACK_IMPORTED_MODULE_7__.MOCK_PREFIJOS;
      this.prefijos$.next(mock);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.of)(mock).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.delay)(500));
    }
    return this.base.getEntitiesByNameRange('Catalogos', 'PrefijoDef').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.map)(data => {
      this.prefijos$.next(data || []);
      return data || [];
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.catchError)(this.base.handleError));
  }
  save(_entity, _entities) {
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.name === 'local') {
      ...
      if (_entity.PREFIX) {
        const prefijo = _mocks_mock_prefijos__WEBPACK_IMPORTED_MODULE_7__.MOCK_PREFIJOS.find(p => p.PREFIX === _entity.PREFIX);
        if (prefijo) {
...
_RecibosService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjectable"]({
...
class UserService {
  ...
  getUsers(nombre, password) {
    if (src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.name === 'local') {
...
//# sourceMappingURL=main.e239804cb2600ad7.js.map